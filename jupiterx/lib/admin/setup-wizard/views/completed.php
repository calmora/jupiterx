	...
	<div class="row">
		<div class="col-4">
			...
			<ul class="jupiterx-help-links list-unstyled">
				...
				<li><a href="<?php echo esc_url( 'https://help.artbees.net/getting-started' ); ?>" target="_blank" class="text-secondary"><i class="fa fa-book"></i> <?php esc_html_e( 'Documentation', 'jupiterx' ); ?></a></li>
			</ul>
		</div>
		<div class="col-4">
