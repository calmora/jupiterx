	...
	<div class="row">
		<div class="col">
			...
			<ul class="list-unstyled">
				<li><a class="list-with-icon icon-video" target="_blank" href="https://themes.artbees.net/support/jupiterx/videos/"><?php esc_html_e( 'Watch Videos', 'jupiterx' ); ?></a></li>
				<li><a class="list-with-icon icon-docs" target="_blank" href="https://help.artbees.net/getting-started"><?php esc_html_e( 'Read Documentation', 'jupiterx' ); ?></a></li>
			</ul>
		</div>
		<div class="col">
